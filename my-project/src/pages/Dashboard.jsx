...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 min-h-screen w-full bg-gradient-to-r from-blue-100 to-gray-200 relative">
      <button onClick={handleLogout} className="absolute top-6 right-6 bg-red-500 text-white px-4 py-2 rounded">Logout</button>
      <h1 className="text-4xl font-bold text-center mb-6 text-blue-500">Dashboard</h1>
